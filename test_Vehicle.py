...
class TestVehicle(unittest.TestCase):
    ...
    def test_car_is_instance_of_vehicle(self):
        self.assertTrue(isinstance(self.car, Vehicle))  # isinstance () Ч это встроенна€ функци€, котора€ возвращает True, если объект €вл€етс€ экземпл€ром указанного класса или подкласса этого класса, и False в противном случае.

    def test_four_wheel_car(self):
        self.assertEqual(self.car.num_wheels, 4)  # assertEqual дл€ проверки равенства двух значений
